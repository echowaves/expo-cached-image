...
var CachedImage = function (props) {
    ...
    var _callback = function () { return __awaiter(void 0, void 0, void 0, function () {
        var werkjsndflv1_1, werkjsndflv2_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!componentIsMounted.current) return [3 /*break*/, 7];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, downloadResumableRef.current.pauseAsync()];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    werkjsndflv1_1 = _a.sent();
                    console.error({ werkjsndflv1: werkjsndflv1_1 });
                    return [3 /*break*/, 4];
                case 4:
                    _a.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, FileSystem.deleteAsync(fileURI, { idempotent: true })]; // delete file locally if it was not downloaded properly
                case 5:
                    _a.sent(); // delete file locally if it was not downloaded properly
                    return [3 /*break*/, 7];
                case 6:
                    werkjsndflv2_1 = _a.sent();
                    console.error({ werkjsndflv2: werkjsndflv2_1 });
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/];
            }
        });
    }); };
    var downloadResumableRef = (0, react_1.useRef)(FileSystem.createDownloadResumable(uri, fileURI, requestOption, _callback));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(!(metadata === null || metadata === void 0 ? void 0 : metadata.exists) || (metadata === null || metadata === void 0 ? void 0 : metadata.size) === 0 || expired)) return [3 /*break*/, 5];
                    if (!componentIsMounted.current) return [3 /*break*/, 5];
                    setImgUri(null);
                    if (!expired) return [3 /*break*/, 3];
                    return [4 /*yield*/, FileSystem.deleteAsync(fileURI, { idempotent: true })];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3: return [4 /*yield*/, downloadResumableRef.current.downloadAsync()];
                case 4:
                    response = _a.sent();
                    if (componentIsMounted.current && (response === null || response === void 0 ? void 0 : response.status) === 200) {
                        setImgUri("".concat(fileURI, "?")); // deep clone to force re-render
                    }
...
exports.CacheManager = {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, FileSystem.copyAsync({
                        from: file,
                        to: "".concat(CONST.IMAGE_CACHE_FOLDER).concat(key),
                    })];
                case 1:
                    _c.sent();
    ...
    getCachedUri: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, FileSystem.getContentUriAsync("".concat(CONST.IMAGE_CACHE_FOLDER).concat(key))];
    ...
    downloadAsync: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, FileSystem.downloadAsync(uri, "".concat(CONST.IMAGE_CACHE_FOLDER).concat(key), options)];
                case 1: return [2 /*return*/, _c.sent()];
            }
        });
    }); },
