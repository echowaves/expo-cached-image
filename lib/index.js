...
var CachedImage = function (props) {
    var source = props.source, cacheKey = props.cacheKey, placeholderContent = props.placeholderContent;
    var uri = source.uri, headers = source.headers, expiresIn = source.expiresIn;
    var fileURI = "".concat(CONST.IMAGE_CACHE_FOLDER).concat(cacheKey);
    var _a = (0, react_1.useState)(fileURI), imgUri = _a[0], setImgUri = _a[1];
    var componentIsMounted = (0, react_1.useRef)(true);
    ...
    var loadImage = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    metadata = _a.sent();
                    expired = Boolean(metadata.exists && expiresIn &&
                        new Date().getTime() / 1000 - metadata.modificationTime > expiresIn);
                    if (!(!metadata.exists || (metadata === null || metadata === void 0 ? void 0 : metadata.size) === 0 || expired)) return [3 /*break*/, 5];
                ...
                case 3:
                    // download to cache
                    setImgUri(null);
                    return [4 /*yield*/, downloadResumableRef.current.downloadAsync()];
                case 4:
                    response = _a.sent();
    ...
    {...props} source={__assign(__assign({}, source), { uri: imgUri })}/>);
};
exports.CacheManager = {
    addToCache: function (_a) {
        var file = _a.file, key = _a.key;
    ...
    downloadAsync: function (_a) {
        var uri = _a.uri, key = _a.key, options = _a.options;
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
