...
export var CacheManager = {
    ...
    getMetadata: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var sanitizedKey, fileURI, metadata, err_2;
        var key = _b.key;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    sanitizedKey = CONST.sanitizeCacheKey(key);
                    fileURI = "".concat(CONST.IMAGE_CACHE_FOLDER).concat(sanitizedKey, ".png");
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, FileSystem.getInfoAsync(fileURI)];
                case 2:
                    metadata = _c.sent();
                    if (!(metadata === null || metadata === void 0 ? void 0 : metadata.exists)) {
                ...
                case 3:
                    err_2 = _c.sent();
                    console.error("Error getting cache metadata:", err_2);
                    return [2 /*return*/, null];
